# 🏀 NBA Evolution of Strategy (2000–2024)
...
## 📊 Project Structure
NBA Evolution of Strategy/
├── data/ # Processed datasets (CSV)
│ ├── finalized_NBA_data.csv
│ └── basic_NBA_data.csv
├── notebooks/ # Jupyter notebooks (exploration & testing)
├── outputs/ # Saved figures (PNG format)
├── src/ # Final analysis script
│ └── nba_analysis_final.py
